...
class AdminConfig:
    ...
    base_url: str = os.environ.get("ADMIN_BACKEND_URL", "https://smsly-backend:80")
    staff_api_url: str = os.environ.get("ADMIN_STAFF_API_URL", "https://smsly-backend:80/api/staff")
